...
<footer>
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12 col-md-3">
					<div class="footer-links">
						<h4>相关链接</h4>
						<ul class="links">
							<li><a href="#" title="Product Recall">鲜花总店</a></li>
							<li><a href="#" title="Gift Vouchers">美丽心情鲜花店</a></li>
							<li><a href="#" title="Returns &amp; Exchange">时尚 &amp; 花朵</a></li>
							<li><a href="#" title="Shipping Options">浮游鲜花</a></li>
							<li><a href="#" title="Help &amp; FAQs">有道 &amp;鲜花 </a></li>
							<li><a href="#" title="Order history">物语鲜花</a></li>
						</ul>
					</div>
				</div>
				<div class="col-sm-4 col-xs-12 col-md-3">
						...
						<div class="footer-newsletter">
							...
							<form id="newsletter-validate-detail" method="post" action="#">
								<div class="newsletter-inner">
									<p>订阅，获得更新鲜花信息，折扣，优惠！</p>
									<input class="newsletter-email" name='Email' placeholder='邮箱'>
	...
	<div class="footer-top">
		<div class="container">
			<div class="row">
				<div style="text-align:center"> <a href="${pageContext.request.contextPath}/"><img src="${pageContext.request.contextPath}/user/images/foot.jpg" alt="logo"> </a> </div>
				<address>
					<p> <i class="fa fa-map-marker"></i>合作, 12/34 - 21世纪西大街, 纽约, 美国 </p>
